...
- FIN yalnız POST gövdəsində qəbul edilir; URL, brauzer yaddaşı, tətbiq logu və DB-də tam mətn kimi saxlanmır. DB-də kampaniya konteksti ilə HMAC-SHA256 və son 2 simvolun maskası var. İnfrastrukturda HTTP gövdələrinin və SQL bind parametrlərinin loglanmasını söndürün. Production HTTPS istifadə etməlidir.
...
- Nömrələr bütün kampaniyalar üzrə vahid, tranzaksiya ilə kilidlənən sayğacdan gəlir. İlk uğurlu nömrə `K-0000001`-dir. Uğursuz tranzaksiya nömrə sərf etmir. İştirakın identifikatorlarını dəyişmək və iştirak sətrini silmək DB trigger-i ilə bloklanır. Ləğv FIN-i və nömrəni azad etmir. İstifadəçi silindikdə FK null olur, rezervasiya saxlanır. Tətbiq DB istifadəçisinə TRUNCATE/DDL icazəsi verməyin.
